    ...
    return (
        ...
        " >
            ...
            ">
                ...
                <div onClick={expandMenu} className="group sm:hidden text-xl font-semibold text-white py-2 px-4 border-2 border-green-600 hover:bg-green-600 hover:border-white rounded-lg">
        ...
        {/* Mobile action */}
            ...
            >
                ...
                ">
                    <Link to="/API">
                        <div className="text-xl text-center font-semibold text-green-500 py-2 px-4 duration-75 hover:bg-indigo-400 rounded-2xl"> API</div>
                    </Link>
                    <div className="text-xl text-center font-semibold text-green-500 py-2 px-4 duration-75 hover:bg-indigo-400 rounded-2xl"> project 2</div>
                    <div className="text-xl text-center font-semibold text-green-500 py-2 px-4 duration-75 hover:bg-indigo-400 rounded-2xl"> project 3</div>
                    <div className="text-xl text-center font-semibold text-green-500 py-2 px-4 duration-75 hover:bg-indigo-400 rounded-2xl"> Project 4</div>
                </div>
            </div>
        </>
    )
